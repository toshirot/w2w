...
約10年くらい前(たぶん2012年頃?)に、WebSocketのネットワークを繋いでいったら面白いのじゃないかと思って話したら、何故かいきなり横から「そんなのP2Pじゃないっ!」と言われて凹んで、2022年となり、既にその人が誰だったかも忘れ(^^;、年取ったし、まぁ他の人はどうでもいいから自分が面白そうと思うなら、自分のできる範囲でやってみようと思ったのが、このプロジェクトを始めた動機です。勇気づけてくれる方もいたので、感謝しつつ。
